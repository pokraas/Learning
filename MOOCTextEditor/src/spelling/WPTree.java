...
public class WPTree implements WordPath {
	...
	//maximum amount of words searched
	...
	public List<String> findPath(String word1, String word2) 
	{
		...
		while (count<THRESHOLD && !q.isEmpty()) {
			WPTreeNode curr = q.remove();
			for (String s : nw.distanceOne(curr.getWord(),true)) {
				WPTreeNode newNode = curr.addChild(s);
				//If found word2
				if (newNode.getWord().equals(word2)) {
