...
public class AutoCompleteDictionaryTrieTester {
	 ...
	 */
	public void basicTestPredictCompletions() {
		List<String> completions;
		completions = smallDict.predictCompletions("he", 2);
		completions = smallDict.predictCompletions("subse", 2);
		completions = smallDict.predictCompletions("subseque", 2);
		completions = smallDict.predictCompletions("subsequent", 2);
		completions = smallDict.predictCompletions("qwe", 2);
	}
